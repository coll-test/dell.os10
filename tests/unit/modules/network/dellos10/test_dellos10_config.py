...
from ansible_collections.dell.os10.tests.unit.compat.mock import patch
from ansible_collections.dell.os10.plugins.modules import dellos10_config
from ansible_collections.dell.os10.tests.unit.modules.utils import set_module_args
...
class TestDellos10ConfigModule(TestDellos10Module):
    ...
    def setUp(self):
        ...
        self.mock_get_config = patch('ansible_collections.dell.os10.plugins.modules.dellos10_config.get_config')
        self.get_config = self.mock_get_config.start()

        self.mock_load_config = patch('ansible_collections.dell.os10.plugins.modules.dellos10_config.load_config')
        self.load_config = self.mock_load_config.start()

        self.mock_run_commands = patch('ansible_collections.dell.os10.plugins.modules.dellos10_config.run_commands')
