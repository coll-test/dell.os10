...
from ansible_collections.dell.os10.plugins.modules import dellos10_command
...
class TestDellos10CommandModule(TestDellos10Module):
    ...
    def setUp(self):
        ...
        self.mock_run_commands = patch('ansible_collections.dell.os10.plugins.modules.dellos10_command.run_commands')
